...
$ cd Kubernetes
# 编辑源码,将 Kubernetes/cmd/kubeadm/app/util/pkiutil/pki_helpers.go文件中的CertificateValidity乘以100
...
$ sed -i 's/CertificateValidity/CertificateValidity * 100/g'   cmd/kubeadm/app/util/pkiutil/pki_helpers.go
$ cat cmd/kubeadm/app/util/pkiutil/pki_helpers.go | grep CertificateValidity
		NotAfter:     time.Now().Add(kubeadmconstants.CertificateValidity * 100).UTC(),
